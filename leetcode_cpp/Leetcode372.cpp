//
// Created by 刘汉乙 on 2021/5/28.
//
#include<vector>
#include <iostream>

using namespace std;
vector<int> scale(vector<int>& b){
    vector<int> newB;
    int remainder =0;
    for(int num:b){
        if(remainder == 1){
        ...
        //去除开头0
        if(newB.size() == 1 && newB[0] == 0)    newB.pop_back();
    }

    if(remainder == 1) newB.push_back(1);
